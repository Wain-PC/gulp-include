    ...
    function processInclude(content, filePath, sourceMap) {
        ...
        do
        {
            ...
            if (includeCondition && includePropName) {
                ...
                if (!((includeCondition === 'is' && (argv.hasOwnProperty(includePropName) || params.args.hasOwnProperty(includePropName))) ||
                    (includeCondition === 'not' && !(argv.hasOwnProperty(includePropName) || params.args.hasOwnProperty(includePropName))))) {
